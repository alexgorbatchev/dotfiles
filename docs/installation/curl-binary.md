...
- [GitHub Release](./github-release.md) - Better for GitHub-hosted tools
- [Curl Tar](./curl-tar.md) - For tarball downloads
- [Curl Script](./curl-script.md) - For installation scripts
