...
name: git-bug
description: >-
  git-bug issue tracking embedded in git. Use when managing bugs/issues,
  creating tickets, listing issues, or working with the git-bug tool. Covers
  creating bugs, pushing/pulling bug refs, and configuring git for automatic
  sync.
targets:
  - '*'
---
