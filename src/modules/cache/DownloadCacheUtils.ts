 ...
 */
export class DownloadCacheUtils {
  /**
   ...
   */
  static createCacheKey(url: string, options: DownloadOptions = {}): string {
   ...
   */
  static createApiCacheKey(url: string, headers?: Record<string, string>): string {
    const keyData = {
      url,
      headers: headers || {},
    };
   ...
   */
  static isDownloadKey(key: string): boolean {
