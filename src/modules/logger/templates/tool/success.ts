...
export const toolSuccessTemplates = {
  ...
  removed: (toolName: string) => createSafeLogMessage(`Tool "${toolName}" removed successfully`),
  processing: (toolName: string, operation: string) => createSafeLogMessage(`Processing ${toolName} (${operation})`),
