...
export const githubClientDebugTemplates = {
  ...
  constructorDebug: (): SafeLogMessage => 
    createSafeLogMessage('baseURL=%s, token=%s'),
  requestDebug: (): SafeLogMessage => 
    createSafeLogMessage('Making request: %s %s'),
  responseDebug: (): SafeLogMessage => 
    createSafeLogMessage('Response: status=%d, headers=%o'),
  rateLimitInfo: (): SafeLogMessage => 
    createSafeLogMessage('Rate limit: remaining=%d, reset=%s'),
  retryAttempt: (): SafeLogMessage => 
    createSafeLogMessage('Retry attempt %d/%d for: %s'),
  paginationDebug: (): SafeLogMessage => 
    createSafeLogMessage('Fetching page %d of results'),
  authenticationDebug: (): SafeLogMessage => 
    createSafeLogMessage('Using authentication: %s'),
} as const;