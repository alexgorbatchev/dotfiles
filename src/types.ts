...
export interface GeneratedArtifactsManifest {
  ...
  generatedShellInitFile?: string;

  /** List of symlinks created by the SymlinkGenerator. */
  generatedSymlinks: Array<{
    /** The source path of the symlink, relative to the dotfiles repository. */
    sourcePath: string;
    /** The target path of the symlink, typically in the user's home directory. */
    linkPath: string;
  }>;
