---
name: bun
description: Bun runtime and bundler API reference. Use when working with Bun for HTTP servers, WebSockets, routing, file I/O, databases (SQL, SQLite, Redis, S3), bundling, HMR, CSS, plugins, shell scripting, or other Bun-specific APIs.
---
