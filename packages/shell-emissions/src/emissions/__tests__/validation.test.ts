...
describe("validation", () => {
  describe("validateIdentifier", () => {
    ...
    it("should reject identifiers starting with numbers", () => {
      expect(() => validateIdentifier("environment", "name", "123var")).toThrow(EmissionValidationError);
    });

    it("should reject identifiers with hyphens", () => {
      expect(() => validateIdentifier("environment", "name", "my-var")).toThrow(EmissionValidationError);
    });
    ...
    it("should reject identifiers with special characters", () => {
      expect(() => validateIdentifier("environment", "name", "var$name")).toThrow(EmissionValidationError);
    });
  });
  ...
  describe("validateNonEmptyObject", () => {
    ...
    it("should reject empty objects", () => {
      expect(() => validateNonEmptyObject("environment", "variables", {})).toThrow(EmissionValidationError);
    });
  });
  ...
  describe("validateEnvironmentVariables", () => {
    ...
    it("should reject invalid variable names", () => {
      expect(() => validateEnvironmentVariables({ "invalid-name": "value" })).toThrow(EmissionValidationError);
    });
  });
