 ...
 */
export type VirtualEnvResult = { success: true; envDir: string; envName: string } | { success: false; error: string };

/**
 * Result of checking for an active environment.
 */
export type ActiveEnvResult = { active: true; envDir: string; envName: string } | { active: false };

/**
 * Result of detecting an environment in a directory.
 */
export type DetectEnvResult = { found: true; envDir: string; envName: string; configPath: string } | { found: false };
