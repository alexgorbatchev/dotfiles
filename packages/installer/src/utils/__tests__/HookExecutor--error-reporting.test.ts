...
describe('HookExecutor - error reporting', () => {
  it('prints short tslog error and writes multiline shell output details', async () => {
    ...
    const baseContext: IAfterInstallContext = {
      ...
      homeDir: testDirs.paths.homeDir,
      binDir: testDirs.paths.binariesDir,
      shellScriptsDir: testDirs.paths.shellScriptsDir,
      dotfilesDir: testDirs.paths.dotfilesDir,
      generatedDir: testDirs.paths.generatedDir,
      toolConfig,
