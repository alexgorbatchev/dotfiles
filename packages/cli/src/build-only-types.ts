// ============================================================================
// These types are only used for testing during the build
// ============================================================================
/**
 * @internal
 ...
 */
export type { ISystemInfo as z_internal_ISystemInfo } from "@dotfiles/core";
/**
 * @internal
 * @deprecated Internal type for testing only. NOT part of the public API.
 * Do not use in production code. May change or be removed without notice.
 */
export type { IInstallParamsRegistry as z_internal_IInstallParamsRegistry } from "@dotfiles/core";
/**
 * @internal
 * @deprecated Internal type for testing only. NOT part of the public API.
 * Do not use in production code. May change or be removed without notice.
 */
export type { IKnownBinNameRegistry as z_internal_IKnownBinNameRegistry } from "@dotfiles/core";
/**
 * @internal
 * @deprecated Internal type for testing only. NOT part of the public API.
 * Do not use in production code. May change or be removed without notice.
 */
export type { InstallMethod as z_internal_InstallMethod } from "@dotfiles/core";
/**
 * @internal
 * @deprecated Internal type for testing only. NOT part of the public API.
 * Do not use in production code. May change or be removed without notice.
