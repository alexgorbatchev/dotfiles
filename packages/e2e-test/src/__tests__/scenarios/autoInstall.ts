...
/**
 * Defines test scenarios for auto-install during generate command.
 *
 ...
 *
 * @param testDir - The test directory (import.meta.dir from e2e.test.ts).
 * @param platform - The platform to test on.
 * @param architecture - The architecture to test on.
 */
export function autoInstallScenarios(testDir: string, platform: Platform, architecture: Architecture): void {
